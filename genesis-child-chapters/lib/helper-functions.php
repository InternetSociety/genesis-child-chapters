 ...
 * Internet Chapters.
 *
 * This file adds the required helper functions used in the Internet Chapters Theme.
 *
 ...
 */
function genesis_child_chapters_color_contrast( $color ) {
 ...
 */
function genesis_child_chapters_color_brightness( $color, $change ) {
