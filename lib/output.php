 ...
 * Internet Chapters.
 *
 * This file adds the required CSS to the front end to the Internet Chapters Theme.
 *
...
add_action( 'wp_enqueue_scripts', 'genesis_child_chapters_css' );
/**
 ...
 * @since 2.2.3
 */
function genesis_child_chapters_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'genesis_child_chapters_logo_width', 350 );
