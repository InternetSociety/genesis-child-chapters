...
add_action( 'wp_enqueue_scripts', 'genesis_child_chapters_custom_gutenberg_css' );
/**
 * Outputs front-end inline styles based on colors declared in config/appearance.php.
 *
 * @since 2.9.0
 */
function genesis_child_chapters_custom_gutenberg_css() {
...
CSS;
	...
	$css .= genesis_child_chapters_inline_font_sizes();
	$css .= genesis_child_chapters_inline_color_palette();

	wp_add_inline_style( genesis_get_theme_handle() . '-gutenberg', $css );

}

add_action( 'enqueue_block_editor_assets', 'genesis_child_chapters_custom_gutenberg_admin_css' );
/**
 ...
 * @since 2.9.0
 */
function genesis_child_chapters_custom_gutenberg_admin_css() {
...
CSS;
	...
	$css .= genesis_child_chapters_editor_inline_color_palette();
 ...
 */
function genesis_child_chapters_inline_font_sizes() {
 ...
 */
function genesis_child_chapters_inline_color_palette() {
 ...
 * @return string The editor colors CSS if `editor-color-palette` theme support was declared.
 */
function genesis_child_chapters_editor_inline_color_palette() {
