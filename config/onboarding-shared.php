    ...
    'widgets'          => [
        ...
        'header-right' => [
            [
                ...
                'args' => [
                    'title'  => '',
                    'text'   => '<div class="sec-nav"><a class="search-toggle" role="button"><span class="sr-only">Search Dropdown</span><img class="search-ico" src="/wp-content/themes/genesis-child-chapters/images/search-icon-21px-21px.svg" alt="Search Icon" width="21" height="21" /></a><a class="join customize-unpreviewable" href="https://community.internetsociety.org/s/new-registration">Join</a></div><div class="search-block" style="display: none;"><form class="is-search-form is-disable-submit is-form-style is-form-style-3 is-form-id-540 is-ajax-search" role="search" action="/search/" method="get" target="_self" data-min-no-for-search="1" data-result-box-max-height="400" data-form-id="540"><input name="customize_messenger_channel" type="hidden" value="preview-0" /><input name="customize_autosaved" type="hidden" value="on" /><input name="customize_changeset_uuid" type="hidden" value="dc0b2f39-1120-4274-b43b-4322e61b0ce2" /><label for="is-search-input-540"><input id="is-search-input-540" class="is-search-input" autocomplete="off" name="s" type="search" value="" placeholder="Search by Keyword" /></label><input name="id" type="hidden" value="540" /></form></div>',
                    'filter' => 1,
                    'visual' => 1,
                ],
            ],
